...
JfName.create(name:    '茗雅', ip_address: '192.166.16.4', status: 1, p_nat: 4, p_local: 2, p_suburban: 3, p_int: 5,
              p_emerg: 1)
JfName.create(name:    '工业西', ip_address: '192.166.16.10', status: 1, p_nat: 3, p_local: 5, p_suburban: 2, p_int: 4,
              p_emerg: 1)
JfName.create(name:       '金洲', ip_address: '192.166.16.13', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:       '工业东', ip_address: '192.166.16.12', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:       '汇接局', ip_address: '192.166.16.3', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:       '东河', ip_address: '192.166.16.3', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:       '十里亭', ip_address: '192.166.16.3', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:    '始兴', ip_address: '192.166.16.9', status: 1, p_nat: 3, p_local: 1, p_suburban: 2, p_int: 4,
              p_emerg: 21)
JfName.create(name:       '南雄', ip_address: '192.166.16.5', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name: '坪石通信楼', ip_address: '192.166.16.16', status: 0)
JfName.create(name:       '乐昌通信楼', ip_address: '192.166.16.14', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:       '乐昌河南', ip_address: '192.166.16.15', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
JfName.create(name:       '马坝中华园', ip_address: '192.166.16.7', status: 1, p_nat: 'nat', p_local: 'local',
              p_suburban: 'suburban', p_int: 'int', p_emerg: 'emerg')
